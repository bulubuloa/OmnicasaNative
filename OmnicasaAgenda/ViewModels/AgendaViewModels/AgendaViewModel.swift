...
//
//                let getAppointments: Single<[AppointmentItem]> = self.api.request(method: .get, enpoint: OmnicasaWebAPIModules.appointments.rawValue, requestModel: self.query).asObservable()
